  ...
  return (
    <div>
      ...
      <div className="text-container">
        Kolejka Radość to atrakcja działąjąca w ramach Kolei Linowych. To
        ...
        górskiego. Pasażerowie w trakcie podróży kolejką mają okazję do
        obcowania z sielksim krajobrazem, ale także do obserwowania życia
        bogatej fauny i flory. Wśród mieszkańców trasy można wyróżnić m.in.
        płochacze halne, orły przednie, świstaki, rysie oraz lisy.
      </div>
    </div>
  );
};
